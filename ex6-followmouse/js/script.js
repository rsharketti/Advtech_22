//GLOBAL VARIABLES
var distancePerFrame, destinationX, movetimer, timerCounter = 0;
...
function moveABit(){
	...
	//divide that to get the little amount it should move each frame.-- have it move 1/3 
	//of distance to resemble easing or deceleration. 
	distancePerFrame = x_distance/3;
